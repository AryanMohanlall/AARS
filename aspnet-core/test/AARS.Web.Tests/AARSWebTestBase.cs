...
public abstract class AARSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static AARSWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(AARSWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<AARSDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<AARSDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<AARSDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<AARSDbContext, Task<T>> func)
    {
        T result;
